...
**🌐 Live Demo:** [https://netflix-household-verify-wy4y.onrender.com/](https://netflix-household-verify-wy4y.onrender.com/)
...
3. **(Optional)** Create a `.env` file in your project's root if it's not already there. Check out the [Environment Variables](#environment-variables) section for more info!
...
* **Gmail**: You absolutely need to enable [2-Step Verification](https://myaccount.google.com/two-step-verification) and generate an [App Password](https://support.google.com/accounts/answer/185834?hl=en) from your Google Account.
...
├── test-imap.js          # IMAP testing utilities
└── src/
    └── components/
        ├── EmailAutoDetection.jsx    # Email auto-detection component
        └── EmailFinder.jsx           # Email finder component
```
...
This project is rocking the [MIT License](LICENSE)! Feel free to modify and share as much as you like!
